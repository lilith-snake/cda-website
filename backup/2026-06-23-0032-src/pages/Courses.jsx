      ...
      <section className="section courses-career">
        <div className="container">
          <div className="section-title">
            ...
            <p className="section-subdesc">路徑A認證通過後，可申請列入官方傳訊師名錄，進入平台職業體系</p>
          </div>
          ...
          <div className="career-tiers">
            <div className="career-tier card">
              ...
              <h3>初階傳訊師</h3>
              <p className="tier-desc">完成四階段認證，列入名錄開始接單</p>
              <ul className="tier-benefits">
                <li>每月固定底薪 + 按單提成</li>
                <li>平台統一匹配客戶，無需自行獲客</li>
                <li>累計服務經驗，逐步建立個人評價</li>
              </ul>
            </div>
            ...
            <div className="career-tier card">
              ...
              <h3>中階傳訊師</h3>
              <p className="tier-desc">累計一定服務量且客戶好評達標後晉升</p>
              <ul className="tier-benefits">
                <li>底薪與單次收益隨等級上調</li>
                <li>優先匹配高頻客戶，客流更穩定</li>
                <li>解鎖進階培訓資源，持續提升專業度</li>
              </ul>
            </div>
            ...
            <div className="career-tier card">
              ...
              <h3>高階傳訊師</h3>
              <p className="tier-desc">長期服務積累，客戶滿意度持續優秀</p>
              <ul className="tier-benefits">
                <li>收入結構進一步優化，平台分成比例降低</li>
                <li>列入精選推薦位，獲得更多曝光</li>
                <li>可參與案例研究，貢獻實操數據至論文</li>
              </ul>
            </div>
            ...
            <div className="career-tier card">
              ...
              <h3>督導級傳訊師</h3>
              <p className="tier-desc">經協會審核邀請，參與體系建設</p>
              <ul className="tier-benefits">
                <li>享有培訓課酬與考核評審收入</li>
                <li>參與新生代傳訊師的培養與評審</li>
                <li>在學術論文中署名致謝，建立行業聲譽</li>
              </ul>
            </div>
          </div>

          <div className="career-note">
            <p>平台為認證傳訊師提供穩定客源與底薪保障，定價參考市場水平、兼顧客戶支付能力。具體薪資結構與晉升標準由入職時另行約定。</p>
          </div>
        </div>
      </section>
