...
echo "🎉 部署完成！"
echo ""
echo "  前台: https://lilith-snake.github.io/cda-website"
echo "  问卷: https://lilith-snake.github.io/cda-website/survey.html"
echo "  申请对接表: https://lilith-snake.github.io/cda-website/application-notify.html"
echo "  后端 API: https://cda-website-3t2.pages.dev/api"
