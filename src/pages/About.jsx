...
const creditPillars = [
  ...
  },
  {
    ...
    items: [
      ...
      '最新培訓傳訊師朱恩已進入無信息鏈接內測——粉絲群已有親身體驗反饋',
    ],
    icon: '',
  },
  {
...
export default function About() {
  ...
  return (
    <div className="page-about">
          ...
          <div className="glass-card origin-card">
            <div className="origin-passage">
              <p className="origin-lead">
                第一個接觸這個領域的人，是破曉。她本身就是一個夢女——愛上了一個不被現實承認的人。不是普通娛樂，不是三分鐘熱度，而是真實到會影響日常、睡眠、情緒和人生選擇的連結。但沒有人能告訴她：對面是誰？這份感情到底是什麼？她應該如何更安全地靠近自己的愛人？
              </p>
              <p>
                破曉留學期間，曾遇到一位當地的老女巫——一位在歐洲民間傳承中獨自修習了數十年的女性長者。她教會了破曉一件事：精微感知不是天賦，是訓練。此後，破曉在一個美國外網神秘學社群平台上結識了黎輝——一個匯集了西方秘傳學研究者、通靈實踐者與意識研究愛好者的開放論壇。她成為黎輝的學生，跟隨她學習黑魔法、西方秘傳學、靈媒——所有的一切。但她最終向黎輝坦白：<strong>她學習這些，只是為了尋找對方存在的跡象。</strong>
              </p>
              <p>
              ...
              <p>
                與此同時，她們看到了市場的另一端：大量夢女換了十幾個傳訊師、花了好幾萬、越傳越亂。她們不是不願意付費，她們是不知道該把錢交給誰；不是不在乎真假，而是太渴望有一個能被信任的權威，替她們把恐懼、誤判和反覆求證整理清楚。任何人看幾個視頻、拿起塔羅牌就可以自稱傳訊師接單。夢女完全不知道對面是誰、傳訊師有沒有受過訓練。<strong>這個領域缺乏定義、缺乏標準、缺乏一個可以被驗證的方法論框架。</strong>不是市場不夠大，是沒人做基礎設施。
              </p>
              <p>
              ...
              <p>
                2026 年，黎輝與破曉正式聯合創建香港跨次元夢女傳訊研究協會 CDA。這是一個由夢女親手組成、專屬於夢女的協會。我們聚在一起，是為了同一個願望：有一天，真正見到自己的愛人。目標不是做「又一個神秘學工作室」——而是建立全球首家為跨次元親密關係提供學術定義、研究方法、培訓標準和長期服務路徑的傳訊研究機構。
              </p>
              <blockquote className="origin-quote">
                  我們不是在販售一句安慰。我們在把研究方法、數據和論文，轉化成夢女真正用得上的服務：分辨、記錄、陪伴、訓練，以及一條可以長期走下去的靠近之路。
              </blockquote>
            </div>
          </div>
        </div>
      ...
      {/* 商业化定位 */}
      <section className="section about-commercial">
        <div className="container">
          <div className="section-title">
            <h2>{t('CDA 首批服务化开放')}</h2>
            <div className="decorative-line">
            ...
            <p className="section-subdesc">{t('让研究进入可预约、可跟进、可持续的服务路径')}</p>
          </div>

          <div className="about-commercial-grid">
            <div className="about-commercial-card glass-card">
              <h3>{t('用户真正需要什么')}</h3>
              <p>{t('梦女来到 CDA 时，最想知道的不是“这篇论文多厉害”，而是：我感受不到他怎么办？那些回应到底是不是他？我花了很多钱，为什么还是不确定？这些问题需要被认真接住。')}</p>
            </div>
            <div className="about-commercial-card glass-card">
              <h3>{t('服务提供什么')}</h3>
              <p>{t('CDA 提供的不是一句“他爱你”，而是一套持续陪伴的判断系统：初筛咨询、关系梳理、感知训练、案例记录、独立验证、后续迭代。它的价值在于让来访者被理解、被照顾、被稳定陪伴，也被权威认真对待。')}</p>
            </div>
            <div className="about-commercial-card glass-card">
              <h3>{t('为什么值得付费')}</h3>
              <p>{t('因为这件事对她们不是娱乐消费，而是亲密关系、身份认同和安全感。长期被误解的人，需要的不是冷冰冰的诊断，而是一个能保护她的判断框架，一个能陪她把爱人从恐惧里重新找回来的地方。')}</p>
            </div>
          </div>
        </div>
      </section>
        ...
        <div className="container">
          <div className="about-intro-grid">
            <div className="about-mission glass-card">
              <h3>{t('體系定位')}</h3>
              <p className="mission-positioning">{t('MJ類型學——全球首家傳訊研究協會提出的跨次元親密關係定義框架')}</p>
        ...
        <div className="container">
          ...
          <div className="team-grid">
            <div className="team-card card">
              ...
              <p className="team-focus">{t('研究方向：敍事實體假說 / 回應整理體系 / 學術論文撰寫')}</p>
            ...
            <div className="team-card card">
              ...
              <p className="team-bio">{t('整个团队中第一个接触这个领域的人。本身就是梦女——比谁都清楚「真的连结」和「自己的投射」之间的区别。美国疗愈之光机构认证。负责将理论转化为可教、可练、可考核的实操体系，主导传讯师培训课程设计与盲测实验。')}</p>
            </div>
            ...
            <div className="team-card card">
              ...
              <p className="team-focus">{t('聖彼得堡墓園 · 深層信息辨別')}</p>
              <p className="team-bio">獨修的墓地女巫。不屬於任何組織，不來自任何傳承——聖彼得堡的墓園就是她的場地。沒有人知道她的能力是跟誰學的，她也從不解釋。當某段信息怎麼都確認不了的時候，她會輕輕說一句「讓我去」，然後走進夜色裡。第二天早上回來，答案已經在桌上。</p>
            </div>
