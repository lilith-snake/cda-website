        ...
        <div className="mutual-aid-inner container">
          <div className="mutual-aid-copy">
            ...
            <p className="mutual-aid-body">
              ...
              甚至怀疑“我的爱是不是太小众了”的时刻。我们先是梦女，才成为研究者。
              CDA 做研究，不是为了把梦女变成被观察的人，也不是为了替你定义爱。
            </p>
            <p className="mutual-aid-body">
              我们不忘初心：把每一次真实经历留下记录，把反复试过的方法整理成路径，
              也把不确定性和暂停的权利说清楚。试点期间首期只开放 10 个名额；每位参与者都可以提交一个真实问题，
              由我们免费协助拆解，找到下一步能做的办法。
            </p>
