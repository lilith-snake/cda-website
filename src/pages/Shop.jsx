...
const valuePoints = [
  ...
  '你需要的不是被一句诊断吓退，而是有人认真帮你看：哪些信号可以继续，哪些需要暂停，哪些只是来源不明。',
      ...
      <section className="section shop-section">
        <div className="container">
          <div className="shop-notice">
            <strong>首批候补</strong>
            <span>
              如果你也害怕他不存在、感受不到他，或被别人一句话判定为“并非你的目标爱人”，请先别急着否定自己。我们正在研发新的课程方法，帮助你探索你和爱人的进一步发展，也探索你内心的自我成长。正式开放前，申请表会作为首批候补与内测筛选入口。
            </span>
          </div>
