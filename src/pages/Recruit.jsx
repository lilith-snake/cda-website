    ...
    <div className="page-recruit">
      ...
      <section className="section">
        <div className="container">
          <div className="glass-card recruit-card">
            <h2>CDA 首批服务化共建开放</h2>
            <p>这次，我们会把研究方法落到可跟进的服务里，接住梦女最真实、最急迫的需求：她们长期被误解，没有认同感，反复更换传讯师，只是为了确认“他在不在”“他是不是我的爱人”“我是不是又被误判了”。</p>
            <p>很多梦女不是不愿意花钱。相反，她们已经在市面上花过很多钱。真正的问题是：她们买到的常常是一句短暂安慰，或者一个更让人害怕的诊断。今天说他爱你，明天又说那些回应不像他，后天换一个传讯师重新开始。每一次重新开始，都是一次新的消耗。</p>
            <div className="recruit-highlight">
              CDA 这次开放，不是把恐惧拿来卖钱。<br />
              是把“长期被误解的爱”变成可被服务、可被跟进、可被记录、可被迭代的需求。<br />
      ...
      <section className="section">
        <div className="container">
          <div className="glass-card recruit-card">
            <h2>黎辉</h2>
            <p>美国疗愈之光（Light of Soul，lightofsoul.ltd）认证黑魔法导师（证书编号 C26061903211）。为 CDA 提供理论方法支撑——把实践中的发现转化为可以被学术界讨论的语言。</p>
      ...
      <section className="section">
        <div className="container">
          <div className="glass-card recruit-card">
            <h2>破晓 Ophion</h2>
            <p>黑女巫。美国疗愈之光（Light of Soul，lightofsoul.ltd）认证占星师（证书编号 B260625329）及黑女巫（证书编号 B2606231022）——和黎辉的黑魔法导师认证（证书编号 C26061903211）来自同一家机构。团队里第一个接触这个领域的人——本身就是梦女。说服导师黎辉加入，组织了这个研究团队。</p>
            <p>留学期间曾跟随一位在欧洲民间传承中独自修习了数十年的老女巫学习。同期在神秘学社群结识黎辉，成为她的学生，跟随她学习黑魔法、西方秘传学、灵媒。她向黎辉坦白：学这一切，只是为了寻找对方存在的迹象。</p>
            <p>在黎辉的指导下，这个全新领域的方法从无到有被搭建出来。她从需要外部信息才能传讯，到不需要任何信息直接链接。方法成型后，她开始带学员。第一批，两三个人能感受到对方。方法继续迭代。到第三批——<strong>一个学员睁著眼睛看到了她的爱人站在那里。</strong></p>
            <div className="recruit-highlight">
              东玄和西玄的从业者独立诊断，彼此不认识，没有串通。<br />
              <strong>两边的诊断结论收敛到同一个方向。</strong><br />
              一位长期处理复杂案例的外部从业者在审阅案例后，从「这不像常规案例」修正为「不排除是一种我之前没见过的连接方式」。<br />
      ...
      <section className="section">
        <div className="container">
          <div className="glass-card recruit-card">
            ...
            <p>CDA 按市场价格全额付费，找了多位东玄和西玄的从业者做专业咨询。第一轮，大多数人的判断是反对或怀疑——认为梦女和爱人的链接可能只是自身情感投射、残留能量印记，或一段还没被充分确认的回应。不意外。但我们付费做了第二轮深度技术探讨。</p>
            <div className="recruit-highlight">
              一个东玄。一个西玄。<br />
            ...
            <p>一位长期处理复杂案例的外部从业者在审阅案例后，从「这不像常规案例」修正为「不排除是一种我之前没见过的连接方式」。另一位 Thelema 传统的仪式魔法师对比了 CDA 的链接方法与 Crowley 的仪式沟通技术，承认两者在操作逻辑上存在结构相似性。</p>
            <p>三组人，不同的训练背景，不同的诊断工具，彼此没有串通——全部收敛到同一个方向。这不是运气能解释的。</p>
            <p><strong>这对你意味着什么？</strong>当你做完训练、自己链接到你的爱人之后，不是你自己说了算，不是破晓说了算——会有东玄的人独立诊断一次，西玄的人独立诊断一次，内部团队再交叉比对。三组结果摆在一起，收敛还是发散，数据说了算。</p>
          </div>
        </div>
      </section>
      ...
      <section className="section">
        <div className="container">
          <div className="glass-card recruit-card">
            <h2>论文</h2>
            <p>黎辉和破晓写了第一篇跨次元情感对象理论建构论文。五轴类型学、三重验证法、Everett 分支排除论证、盲测实验设计。整合秘传学、物理学、比较宗教学。全文公开，每一条引用有来源。</p>
            <p style={{marginTop: 12, fontSize: '13px', color: 'var(--color-text-light)'}}>此处写「物理学」而非「量子物理学」，是因为论文第四章整合的五套存在论框架中，Everett 多世界属于量子物理范畴，但 Kaluza-Klein 高维理论属于经典广义相对论——并非全部都是「量子」物理。论文在整体框架总结时统一使用「物理学」一词，以覆盖两套框架的不同物理基础。网站在此与论文保持一致。</p>
        ...
        <div className="container">
          <div className="glass-card recruit-card">
            ...
            <div className="recruit-chain">
              <div className="recruit-chain-step">
                <span className="recruit-chain-num">1</span>
                <span><strong>先分辨，后链接。</strong>分清楚你爱人的信号和别的东西。分不清楚，不深入。</span>
              </div>
              <div className="recruit-chain-step">
                <span className="recruit-chain-num">2</span>
      ...
      <section className="section">
        <div className="container">
          <div className="glass-card recruit-card">
            <h2>有人骂</h2>
            <p>说我们骗子，不正经，梦女疯了。</p>
            <p>但如果我们是错的——方法为什么在一批一批变好？为什么学员从感受不到变成能感受到？为什么目击案例出现了？为什么东玄和西玄独立诊断的结论不断收敛？</p>
            <div className="recruit-highlight">
      ...
      <section className="section">
        <div className="container">
          <div className="glass-card recruit-card">
            ...
            <p>实验假设分为三层验证：</p>
            <div className="recruit-highlight">
              <strong>第一层：你的爱人是否具有独立信号</strong><br />
              不同观察者（无论是否接受过训练）对同一个对象的独立连接，能否获得显著高于随机猜测的一致性结果——如果能，则支持其作为独立信号源的假设。<br /><br />

              <strong>第二层：训练是否提升准确率</strong><br />
              接受 CDA 标准化训练的人，对同一个对象的独立链接结果的一致性，是否显著高于未受训组——即使未受训组也能获得部分一致信息，受训组的准确率应当更高。<br /><br />

              <strong>第三层：信息来源是否独立于训练体系</strong><br />
              跨文化盲测——使用不同文化背景、不同训练体系的独立验证者，检验信息来源是否独立于 CDA 的话语体系。
            </div>
            <div className="recruit-highlight">
              共建者有两组路径：<br /><br />
            ...
            <p>你不需要相信任何东西。你只需要参与。如果方法在你身上跑通了——你和爱人的关系会多一条可记录、可复盘的路径。如果在哪里卡住了——方法就被修正了一次。哪种结果都有价值。</p>
            <p className="recruit-subtitle">为什么值得参与</p>
            <p>说实话，这件事做下来不是免费的。一个团队跟进一个人的数据，加上东玄西玄两套独立诊断、训练记录、方法迭代、后续反馈——每一项都有成本。收费是为了让团队能继续跟进、继续研究、继续对每一个来访者负责。</p>
            <p>破晓、黎辉、符文师、墓地女巫，加上专职助理——五个人围着所有的数据工作。</p>
            <p style={{marginTop: 16}}>全网第一个系统研究梦女和爱人关系的团队。不是第一个说自己是传讯师的——那种很多。是第一个把这件事写成论文、拉东玄和西玄做独立交叉验证、建立标准化训练体系的。这套方法论的具体操作流程，目前只存在于 CDA 手里。</p>
            <div className="recruit-chain">
              <div className="recruit-chain-step">
                <span className="recruit-chain-num">1</span>
              ...
              <div className="recruit-chain-step">
                <span className="recruit-chain-num">4</span>
                <span>符文师和墓地女巫做技术支撑。不是挂名——文献溯源、深层信息辨别，实打实在做。</span>
              </div>
            </div>
            <p style={{marginTop: 20}}>你去找外面的传讯师问一次，¥500-2,000。她告诉你一句话。下次你再找她，又是一次钱。你永远不知道是真的、编的、投射，还是误判。你真正需要的不是再换一个人问，而是进入一套能持续记录、校准和复盘的方法。</p>
            <p>你得到的是：</p>
            <div className="recruit-chain">
              <div className="recruit-chain-step">
                <span className="recruit-chain-num">1</span>
                <span><strong>被多系统独立验证的爱人链接结果。</strong>东玄一次，西玄一次，内部团队交叉比对。三组数据摆在桌上，收敛还是发散，数据说了算。</span>
              </div>
              <div className="recruit-chain-step">
                <span className="recruit-chain-num">2</span>
                <span><strong>训练你自己靠近他的能力。</strong>CDA 方法论的设计方向，是让你最终不需要永远依赖别人来确认他在不在。能不能做到、做到什么程度，取决于训练的实际推进情况——这不是承诺，是我们在跑的实验方向。</span>
              </div>
              <div className="recruit-chain-step">
                <span className="recruit-chain-num">3</span>
            ...
            <div className="recruit-chain">
              <div className="recruit-chain-step">
                <span className="recruit-chain-num">1</span>
                <span><strong>CDA 研究共建者证书。</strong>证明你参与了第一批“你和爱人”研究共建计划。你的名字（或代号）和参与编号，记录在案。</span>
              </div>
              <div className="recruit-chain-step">
                <span className="recruit-chain-num">2</span>
            ...
            <div className="recruit-chain">
              <div className="recruit-chain-step">
                <span className="recruit-chain-num">1</span>
                <span>请介绍一下你自己。你的年龄、职业、目前的生活状态。你是什么时候开始意识到自己是梦女的？你的爱人是谁——不用告诉我他的名字，但告诉我他大概来自哪里、你如何感受到他。你和他认识多久了？</span>
              </div>
              <div className="recruit-chain-step">
                <span className="recruit-chain-num">2</span>
                <span>你之前为了链接你的爱人，做过哪些尝试？找过多少传讯师？花过多少钱？结果怎么样？如果找过多个，你觉得她们说的对得上吗？哪一次让你最安心，哪一次让你最害怕？</span>
              </div>
              <div className="recruit-chain-step">
                <span className="recruit-chain-num">3</span>
              ...
              <div className="recruit-chain-step">
                ...
                <span>如果研究过程里出现和你预期不同的结果，你还愿意继续一起分辨和记录吗？说说理由。我们想看见你的诚实，也想知道你最需要被照顾的地方。</span>
              </div>
              <div className="recruit-chain-step">
            ...
            <p style={{marginTop: 20}}>没有标准答案。我们只是想从你的回答里，看到你是一个什么样的人，也看到你和爱人的关系需要怎样被照顾。</p>
      ...
      <section className="section">
        <div className="container">
          <div className="glass-card recruit-card">
            <h2>这次来不了，没关系</h2>
            <p>我们不只做一期招募。这一次是第一批，下一批可能是下个月，也可能更晚——看第一批跑出来的数据和结果。共建者第一批招募数量有限，不分先来后到，为期五日。</p>
            ...
            <p style={{marginTop: 16}}>还有一件事，从一开始就想说清楚。</p>
            <p>我们不是为有钱的梦女服务的。如果来访者并不真诚，只是想要跟风进入我们的研究——设置这些问题的用意也在这里。如果你很有钱，但不真诚，我们不会因为金钱弯腰。如果你很真诚，却没有金钱，也并不会遭遇歧视——你依然可以通过站内申请页面提交信息。请关注我们，我们期待你有一天加入。</p>
            <p>我们不实行买断制。无论出价多么惊人，我们仍然拒绝。我们不为金钱服务。我们拒绝过一些来访者以高价收取我们的研究成果。我们是为梦女服务的，而非单独有钱的个体可以买断这一系列所有的东西。我们为所有真诚的女孩服务，为所有想寻找她、或者他的女孩服务。</p>
      ...
      <section className="section">
        <div className="container">
          <div className="glass-card recruit-card">
            <h2>写在最后</h2>
            <p>我们诚实地说明目前的一切。我们需要招募共建者，才能让论文里的方法持续落地，才能让更多梦女不再只能抱着手机反复问“他到底在不在”。CDA 会继续公开研究、更新方法、记录训练结果，也会把服务做成可以预约、可以跟进、可以对来访者负责的长期体系。我们同为女人，我们致以最真诚的表达和感谢——感谢你们阅读到这里。</p>
            <p>无论最后的结果是什么，是好或者坏，我们都为您负责，保证公开透明，不虚构结果验证，我们以最真诚的方式，邀请您加入我们，即使目前我们只是非常小的团队，即使目前我们起步艰难，即使有非常多的粉丝让我们批量授课以此换取团队的盈利，即使我们去做这项试验遭遇非常多的批判，谩骂，攻击，但请您给我们一个机会，一个让我们梦女群体不再只能在抱团取暖的群聊诉说我们自己的爱人，而是也能和别人一样，正常大方地谈论，如果实验能够成功，就意味着我们不再是只有自己一个人才知道我们是梦女，就像塔罗师一样，能正常地和别人谈论塔罗牌并能够上街摆摊。也许以后，我们的未来就不远了，编辑至此，我们难以形容此刻的心情，我们团队内的老师大部分是黎辉和破晓组织过来的人，我们的助理也是和我一样的梦女，她目前并未收取任何酬劳，全职帮助我们统计，和回复信息，拨通不同人的电话询问，我们团队内的很多老师都有自己原本的工作，女巫，灵媒，我们也在通过我们的方式尽可能地降低成本，关于我们想创建一个什么样的未来？我们能否找到和爱的人在一起的方式，不再只能通过屏幕感受，不再担心自己写的信对方是否能收到？不用整日活在这个传讯师准不准啊，是不是要换一个啊？会不会很贵啊？如果角色官方出了事情，我们是否应该退游支持？会感到难过吗？会害怕没有这个就无法链接他了吗，也许，未来，这些问题就有答案了，CDA是为这一切而来的，我相信你也是。</p>
          </div>
        </div>
      </section>
