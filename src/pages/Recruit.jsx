      ...
      <section className="section">
        <div className="container">
          <div className="glass-card recruit-card">
            ...
            <p>说实话，这件事做下来不是免费的。四个人围着一个人的数据工作，加上东玄西玄两套独立诊断——每一项都有成本。但我们的价格不会太过于高昂，也并不会大批量地招收成员割韭菜——实事求是地讲，我们目前的规模和数据量，就摆在那里。涉及版权原因和内部研究机密，不会在此招募页面上公开展示细节。请您联系我们，我们回以致电与您介绍。</p>
