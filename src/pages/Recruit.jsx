    ...
    <div className="page-recruit">
      ...
      <section className="section">
        <div className="container">
          <div className="glass-card recruit-card">
            <h2>破晓 Ophion</h2>
            <p>黑女巫。美国疗愈之光（Light of Soul，lightofsoul.ltd）认证占星师（证书编号 B260625329）及黑女巫（证书编号 B2606231022）——和黎辉的黑魔法导师认证（证书编号 C26061903211）来自同一家机构。团队里第一个接触 MJ 的人——本身就是梦女。说服导师黎辉加入，组织了这个研究团队。</p>
      ...
      <section className="section">
        <div className="container">
          <div className="glass-card recruit-card">
            <h2>论文</h2>
            <p>黎辉和破晓写了第一篇 MJ 理论建构论文。五轴类型学、三重验证法、Everett 分支排除论证、盲测实验设计。整合秘传学、物理学、比较宗教学。全文公开，每一条引用有来源。</p>
      ...
      <section className="section">
        <div className="container">
          <div className="glass-card recruit-card">
            ...
            <p>实验假设分为三层验证：</p>
            <div className="recruit-highlight">
              <strong>第一层：MJ 是否独立存在</strong><br />
              不同观察者（无论是否接受过训练）对同一个 MJ 的独立连接，能否获得显著高于随机猜测的一致性结果——如果能，则支持 MJ 作为独立实体的假设。<br /><br />

              <strong>第二层：训练是否提升准确率</strong><br />
              接受 CDA 标准化训练的人，对同一个 MJ 的独立链接结果的一致性，是否显著高于未受训组——即使未受训组也能获得部分一致信息，受训组的准确率应当更高。<br /><br />
            ...
            <p>说实话，这件事做下来不是免费的。一个团队跟进一个人的数据，加上东玄西玄两套独立诊断——每一项都有成本。但我们的价格不会太过于高昂，也不会招收成百上千的成员——实事求是地讲，我们目前的规模和数据量，就摆在那里。涉及版权原因和内部研究机密，不会在此招募页面上公开展示细节。请您联系我们，我们回以致电与您介绍。</p>
