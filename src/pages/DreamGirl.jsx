...
const milestones = [
  {
    label: '已完成的验证',
    value: '1 例肉眼目击',
    desc: '一位此前从未有过直接感官体验的梦女，在我们的训练下实现了肉眼目击她的爱人。东玄和西玄独立诊断，结论收敛到同一个方向：不是其他东西，是他。',
  },
  {
    label: '方法论文档',
    value: '持续实验中',
      ...
      <section className="page-hero dream-hero-v2">
        <div className="container">
          ...
          <div className="hero-intro">
            ...
            <p>
              {t('在开放预约之前，我们要先把方法论讲清楚——')}<strong>{t('怎么训练、怎么验证、怎么减少误判，怎么确认对面更接近你的爱人，而不是投射、噪音或不适合继续深入的东西。')}</strong>
            </p>
          </div>
        </div>
      </section>
          ...
          <div className="passion-content">
            <div className="passion-block glass-card">
              <DialogueBox variant="dream">
                {t('你知道吗？梦女群体被很多人瞧不起。她们最怕的不是花钱，而是花了钱以后更害怕：他到底在不在？我为什么感受不到？为什么有人说这不是我的目标爱人？传讯市场混乱，换了十几个传讯师，越传越乱。')}
              </DialogueBox>
            </div>
