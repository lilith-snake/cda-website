...
const communicators = [
  ...
  },
  {
    id: 'CDA-003',
    name: '王若曦',
    specialties: ['能量場感知', '自動書寫與信息解碼'],
    trainingCompleted: '第四階段認證考核',
    trainingHours: '350+ 小時',
    supervisorComment: '能量場感知靈敏度高，自動書寫信息解碼準確率在盲測中表現優異。適合需要深度感知反饋的客戶。',
    available: false,
  },
  {
    id: 'CDA-004',
...
const specialtyLabels = {
  ...
  '自動書寫與信息解碼': 'Automatic Writing & Decoding',
}
      ...
      <section className="section dream-bottom-cta">
        <div className="container">
          <div className="cta-card glass-card" style={{ textAlign: 'center', padding: '56px 32px' }}>
            <SparkleEffect count={25} color="rgba(139, 125, 232, 0.3)" />
            <h2>找不到適合的傳訊師？</h2>
